...
config.JobType.psetName = '/home/sanders/pPb_2016_ch/VNAnalysis/vnanalysis_cfg.py'
...
config.General.requestName = 'pPb2016_Pbp_HM185_CH_1'
config.Data.outLFNDirBase = '/store/user/ssanders/pPb2016_Pbp_HM185_CH_1'
config.Data.lumiMask = 'Cert_285479-285832_HI8TeV_PromptReco_Pbp_Collisions16_JSON_NoL1T.txt'
config.JobType.inputFiles = ['Cert_285479-285832_HI8TeV_PromptReco_Pbp_Collisions16_JSON_NoL1T.txt','HeavyIonRPRcd_pPb2016_HM185_offline.db']
config.JobType.pyCfgParams = ['noprint','ntrkMin=185','lumifile=Cert_285479-285832_HI8TeV_PromptReco_Pbp_Collisions16_JSON_NoL1T.txt']
