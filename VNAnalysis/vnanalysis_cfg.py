...
ivars.register ('lumifile',
                'Cert_285479-285832_HI8TeV_PromptReco_Pbp_Collisions16_JSON_NoL1T.txt',
...
if ivars.ntrkMin == 0:
    ...
    process.p = cms.Path(process.eventSelection*process.minBias*process.Noff*process.ppNoffFilterMB*process.hiEvtPlane*process.hiEvtPlaneFlat*process.vnanalyzer)
...
if ivars.ntrkMin == 120:
    ...
    process.es_prefer_flatparms = cms.ESPrefer('PoolDBESSource','')
    process.p = cms.Path(process.eventSelection*process.hltHM120*process.Noff*process.ppNoffFilter120*process.hiEvtPlane*process.hiEvtPlaneFlat*process.vnanalyzer)
...
if ivars.ntrkMin == 150:
    ...
    process.es_prefer_flatparms = cms.ESPrefer('PoolDBESSource','')
    process.p = cms.Path(process.eventSelection*process.hltHM150*process.Noff*process.ppNoffFilter150*process.hiEvtPlane*process.hiEvtPlaneFlat*process.vnanalyzer)
...
if ivars.ntrkMin == 185:
    ...
    process.es_prefer_flatparms = cms.ESPrefer('PoolDBESSource','')
    process.p = cms.Path(process.eventSelection*process.hltHM185*process.Noff*process.ppNoffFilter185*process.hiEvtPlane*process.hiEvtPlaneFlat*process.vnanalyzer)
...
if ivars.ntrkMin == 250:
    ...
    process.es_prefer_flatparms = cms.ESPrefer('PoolDBESSource','')
    process.p = cms.Path(process.eventSelection*process.hltHM250*process.Noff*process.ppNoffFilter250*process.hiEvtPlane*process.hiEvtPlaneFlat*process.vnanalyzer)
